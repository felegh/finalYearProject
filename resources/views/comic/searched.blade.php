...
<html lang="{{ app()->getLocale() }}">
    ...
    @endforeach
      ...
      <div class="column">
        @if(count($artist) > 0)
      @foreach($artist as $comics)

      <div class="col-md-4">
            <div class="card mb-4 box-shadow">
              <img class="card-img-top" src="/image/{{$comics->comic}}">
              <div class="card-body">
                <p class="card-text">{{$comics->summary}}</p>
                <div class="d-flex justify-content-between align-items-center">
                  <div class="btn-group">
                    <a class="btn btn-secondary btn-lg btn-block" href="/comic/{{$comics->id}}">{{$comics->title}}</a> </br>
